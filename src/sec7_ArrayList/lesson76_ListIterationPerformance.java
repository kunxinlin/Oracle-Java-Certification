...
public class lesson76_ListIterationPerformance {
...
//        String str;
//        for(Iterator<String> iterator = list.iterator(); iterator.hasNext(); str = iterator.next()) {} //implementation of foreach
    ...
    private static String[] createArray() {
        String[] stringArray = new String[50_000_000];
